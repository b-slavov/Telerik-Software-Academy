...
internal class BinaryTowerOfDoom
{
    private static void Main(string[] args)
    {
        // ALL THE KNIGHTS THAT ARRIVED IN THE CHARIOTS
        int knightsTotalCount = 0;

        // ALL KNIGHTS THAT MADE IT TO THE END
        int knightSurvivorsCount = 0; 
