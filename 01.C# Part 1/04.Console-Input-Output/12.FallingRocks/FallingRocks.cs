...
class FallingRocks
{
    private static readonly ConsoleColor[] RockColors =
    {
        ConsoleColor.Cyan,
        ConsoleColor.Green,
        ConsoleColor.Red,
    ...
    static uint score = 0;
    static byte rockFallSpeed = 200;
    static byte playerMoveSteps = 1;
    ...
    class Rocks
    {
        ...
        public Rocks(int x, int y)
        {
            ...
            this.rockType = symbols[random.Next(0, symbols.Length)];
            this.rockColor = RockColors[random.Next(0, RockColors.Length)];
        }
