namespace Computers.Logic.Manufacturers
{
    ...
    public class DellComputersFactory : IComputersFactory
    {
        ...
        {
            var laptop = new Laptop(new Cpu32(4), new Ram(8), new[] { new SingleHardDrive(1000) }, new ColorVideoCard(), new LaptopBattery());
            return laptop;
        }

        public PersonalComputer CreatePersonalComputer()
        {
            var pc = new PersonalComputer(new Cpu64(4), new Ram(8), new[] { new SingleHardDrive(1000) }, new ColorVideoCard());
            return pc;
        }
