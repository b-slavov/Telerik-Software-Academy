namespace Computers.Logic.Manufacturers
{
    ...
    public class LenovoComputersFactory : IComputersFactory
    {
        ...
        {
            var laptop = new Laptop(new Cpu64(2), new Ram(16), new[] { new SingleHardDrive(1000) }, new ColorVideoCard(), new LaptopBattery());
            return laptop;
        }

        public PersonalComputer CreatePersonalComputer()
        {
            var pc = new PersonalComputer(new Cpu64(2), new Ram(4), new[] { new SingleHardDrive(2000) }, new MonochromeVideoCard());
            return pc;
        }
