namespace Computers.Logic.Manufacturers
{
    ...
    public class HpComputersFactory : IComputersFactory
    {
        ...
        {
            var laptop = new Laptop(new Cpu64(2), new Ram(4), new[] { new SingleHardDrive(500) }, new ColorVideoCard(), new LaptopBattery());
            return laptop;
        }

        public PersonalComputer CreatePersonalComputer()
        {
            var pc = new PersonalComputer(new Cpu32(2), new Ram(2), new[] { new SingleHardDrive(500) }, new ColorVideoCard());
            return pc;
        }
