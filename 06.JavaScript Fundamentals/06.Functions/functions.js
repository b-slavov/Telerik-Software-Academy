...
function problem1() {
    ...
    if (input !== '' && !isNaN(input) && input % 1 === 0) {
        ...
        document.getElementById('pr1answer').innerHTML = 'Result: ' + result;
...
function problem2() {
    ...
    if (input !== '' && !isNaN(input)) {
        ...
        document.getElementById('pr2answer').innerHTML = 'Result: ' + result;
...
function problem3() {
    ...
    if (search !== '') {
        ...
        document.getElementById('notice').innerHTML = '<p>Enter a word to search for</p>';
    }
...
function searchWord(text, search, caseSensitive) {
    ...
    if (clearText === newText) {
        document.getElementById('notice').style.display = 'inline-block';
        document.getElementById('notice').innerHTML = '<p>' + '"' + search + '"' + ' was not found</p>';
    }
}
...
function problem5() {
    ...
    if (validInput && number !== '' && !isNaN(number)) {
        ...
        document.getElementById('pr5answer').innerHTML = 'Result: ' + number + ' &#8594 ' + result + ' times in ' + arr;
        console.log('Problem 5: ' + number + ' &#8594 ' + result + ' times in ' + arr);
    } else {
...
function test() {
    ...
    document.getElementById('pr5test').innerHTML =
        '5 tests were running for the function count(number, array).<br />For a test array [ ' +
        arrTest.join(', ') +
        ' ]<br />count(1, arrTest) = ' + test1 + ' &#8594 ' + (test1 === test1ExpectedResult) +
        ';<br />count(2, arrTest) = ' + test2 + ' &#8594 ' + (test2 === test2ExpectedResult) +
        ';<br />count(3, arrTest) = ' + test3 + ' &#8594 ' + (test3 === test3ExpectedResult) +
        ';<br />count(4, arrTest) = ' + test4 + ' &#8594 ' + (test4 === test4ExpectedResult) +
        ';<br />count(5, arrTest) = ' + test5 + ' &#8594 ' + (test5 === test5ExpectedResult) + ';';
}
...
function problem6() {
    ...
    if (validInput && number !== '' && !isNaN(number) && (number % 1 === 0)) {
        ...
        document.getElementById('pr6answer').innerHTML = 'Result: ' + number + ' is bigger than it\'s neighbours? &#8594 ' + result;
        console.log('Problem 6: ' + number + ' is bigger than it\'s neighbours? &#8594 ' + result);
    } else {
...
function problem7() {
    ...
    if (validInput) {
        ...
        document.getElementById('pr7answer').innerHTML = 'Result: ' + result;
