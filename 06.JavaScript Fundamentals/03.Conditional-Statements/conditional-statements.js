...
function problem2() {
    ...
    if (!isNaN(a) && !isNaN(b) && !isNaN(c) &&
        ...
        document.getElementById('pr2result').innerHTML =
            'Result: The sign is "' + result + '"';
        console.log('Problem 2: The sign is "' + result + '"');
...
function problem3() {
    ...
    if (!isNaN(a) && !isNaN(b) && !isNaN(c) &&
        ...
        if ((a > b && a > c) || (a === b && b === c) || (a === b && a > c) || (a === c && a > b)) {
            greatest += 'is ' + a;
        }
        if ((b > a && b > c) || (b === c && b > a)) {
            greatest += 'is ' + b;
...
function problem6() {
    ...
    if (!isNaN(a) && !isNaN(b) && !isNaN(c) &&
        ...
        if (D < 0) {
            ...
            if (D === 0) {
                result = a + "x^2 + " + b + "x + " + c + " has one real root x=" + xOnlyRoot.toFixed(2);
            } else {
                result = a + "x^2 + " + b + "x + " + c + " has two real roots x1=" + xRoot1.toFixed(2) + " and x2=" + xRoot2.toFixed(2);
            }
        }
...
function problem7() {
    ...
    if (!isNaN(a) && !isNaN(b) && !isNaN(c) && !isNaN(d) && !isNaN(e) &&
        ...
        document.getElementById('pr7result').innerHTML =
            'Result: ' + currentMax;
        console.log('Problem 7: ' + currentMax);
