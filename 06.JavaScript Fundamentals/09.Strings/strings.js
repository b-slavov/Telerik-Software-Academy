...
function problem1() {
    ...
    if (input) {
        document.getElementById('pr1answer').innerHTML = 'Result: ' + reverseString(input);
        console.log('Problem 1: ' + reverseString(input));
    } else {
        document.getElementById('pr1answer').innerHTML = 'Enter a string!';
    }
...
function problem2() {
    ...
    if (input) {
        document.getElementById('pr2answer').innerHTML = 'Result: Correct brackets &#8594 ' + checkBrackets(input);
        console.log('Problem 2: Correct brackets &#8594 ' + checkBrackets(input));
    } else {
        document.getElementById('pr2answer').innerHTML = 'Enter a string!';
    }
...
function problem3() {
    ...
    document.getElementById('pr3answer').innerHTML = 'Result: "' + substring.toLowerCase() + '" is found ' +
        findSubstring(inputText, substring) + ' times.';
...
function problem4() {
    ...
    document.getElementById('pr4answer').innerHTML = 'Result: ' + result;
...
function problem5() {
    ...
    document.getElementById('pr5answer').innerHTML = 'Result: ' + result;
...
function problem6() {
    ...
    document.getElementById('pr6answer').innerHTML = 'Result: ' + result;
...
function problem7() {
    ...
    document.getElementById('pr7answer').innerHTML = 'Result:<br>' +
        '{<br />' + printObj(result) + '}';
    console.log(result);
}
...
function problem9() {
    ...
    document.getElementById('pr9answer').innerHTML = 'Result:<br>' +
...
function problem10() {
    ...
    document.getElementById('pr10answer').innerHTML = 'Result: ' + result;
...
function problem11() {
    ...
    document.getElementById('pr11answer').innerHTML = 'Result:<br>' + result;
}
