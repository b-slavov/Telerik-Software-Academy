...
function problem1() {
    ...
    document.getElementById('pr1answer').innerHTML =
        'Result: Segments 1, 2, and 3 form a triangle? &#8594 ' + canFormTriangle(segment1, segment2, segment3);
    console.log('Segments 1, 2, and 3 form a triangle? &#8594 ' + canFormTriangle(segment1, segment2, segment3));
}
...
function problem2() {
    ...
    result = 'Initial array &#8594 ' + arr + '; Array after removing ' +
        element + ': &#8594 ';
...
function hasProperty(obj, property) {
    if (property in obj) {
        document.getElementById('pr4answer').innerHTML =
            'Result: The object contains a property ' + property + ' with value ' + obj[property] + '.';
        console.log('Problem 4: The object contains a property ' + property + ' with value ' + obj[property] + '.');
    } else {
        document.getElementById('pr4answer').innerHTML =
            'Result: The object doesn\'t contain a property ' + property + '.';
    }
}
...
function generatePeople(problemNumber, attachFunction) {
    var people = [
        new Person('Marshall', 'Mathers', 42),
        new Person('Calvin', 'Broadus', 43),
        new Person('Kanye', 'West', 38),
        new Person('Radric', 'Davis', 35),
        new Person('Dwayne', 'Carter', 32),
        new Person('Nasir', 'Jones', 41),
        new Person('Earl', 'Simmons', 44),
        new Person('William', 'Roberts', 39),
        new Person('Shawn', 'Carter', 45),
        new Person('Andre', 'Young', 50)
    ];
