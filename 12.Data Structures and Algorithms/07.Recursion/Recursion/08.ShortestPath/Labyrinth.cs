    ...
    public class Labyrinth
    {
        ...
        public void Fill()
        {
            ...
            while (currentPath.Count > 0)
            {
                ...
                bool canGoUp = currentCell[0] - 1 >= 0 && (this.Lab[currentCell[0] - 1, currentCell[1]] == "0" || this.Lab[currentCell[0] - 1, currentCell[1]] == "E");
                bool canGoDown = currentCell[0] + 1 < this.Size && (this.Lab[currentCell[0] + 1, currentCell[1]] == "0" || this.Lab[currentCell[0] + 1, currentCell[1]] == "E");
                bool canGoRight = currentCell[1] + 1 < this.Size && (this.Lab[currentCell[0], currentCell[1] + 1] == "0" || this.Lab[currentCell[0], currentCell[1] + 1] == "E");
                bool canGoLeft = currentCell[1] - 1 >= 0 && (this.Lab[currentCell[0], currentCell[1] - 1] == "0" || this.Lab[currentCell[0], currentCell[1] - 1] == "E");
            ...
            if (this.pathFound)
            {
                Console.WriteLine("The shortest distance is " + (this.currentNumber + 1));
            }
            else
            {
